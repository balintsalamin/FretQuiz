...
const CACHE_NAME = 'fretquiz-cache-v5';
...
// Cache-first, falling back to network, and quietly refreshing the
// cache in the background so the next offline visit stays current.
